...
@MappedSuperclass
public class InfoSpot_VersionStructure extends DataManagedObjectStructure {

    protected InfoSpotTypeEnumeration infoSpotType;
    ...
    protected Set<String> infoSpotLocations;
    ...
    public void setInfoSpotLocations(Collection<String> infoSpotLocation) {
        this.infoSpotLocations = new HashSet<>(infoSpotLocation);
    }
