...
public class HslAccessibilityPropertiesMapper {
    public HslAccessibilityProperties mapHslAccessibilityProperties(Map inputMap) {
        ...
        if (inputMap.containsKey(STOP_HEIGHT_FROM_RAIL_TOP)) {
            hslAccessibilityProperties.setStopHeightFromRailTop((Double) inputMap.get(STOP_HEIGHT_FROM_RAIL_TOP));
        }
        if (inputMap.containsKey(STOP_HEIGHT_FROM_SIDEWALK)) {
            hslAccessibilityProperties.setStopHeightFromSidewalk((Double) inputMap.get(STOP_HEIGHT_FROM_SIDEWALK));
        }
