...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION 'Name % already exists for groups of stop places.', NEW.name_value;
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION 'Description % already exists for groups of stop places.', NEW.description_value;
    END IF;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
