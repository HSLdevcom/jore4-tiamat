...
//                .body("nameType", equalTo(altName.getNameType())) //RestAssured apparently does not like comparing response with enums...
    ...
    public void testCreateStopWithTopographicPlaceHSL() {
        TopographicPlace topographicPlace = new TopographicPlace(new EmbeddableMultilingualString("countyforinstance", "lng"));
    ...
    public void testMutateStopChangeTopographicPlaceHSL() {
        TopographicPlace topographicPlaceOrigin = new TopographicPlace(new EmbeddableMultilingualString("original location", "lng"));
        ...
        TopographicPlace topographicPlaceTarget = new TopographicPlace(new EmbeddableMultilingualString("target location", "lng"));
