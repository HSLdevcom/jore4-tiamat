...
//                .body("nameType", equalTo(altName.getNameType())) //RestAssured apparently does not like comparing response with enums...
    ...
    public void testQueryHslAccessibilityPropertiesOfStop() {
              ...
              stopPlace:  stopPlace (query:"%s", allVersions:true) {
                ...
                accessibilityAssessment {
                  ...
                  hslAccessibilityProperties {
                    ...
                    stopHeightFromRailTop
                    stopHeightFromSidewalk
                    lowerCleatHeight
                    serviceAreaWidth
                    serviceAreaLength
        ...
        executeGraphqQLQueryOnly(graphQlJsonQuery)
            ...
            .body("stopHeightFromRailTop", equalTo(hslAccessibilityProperties.getStopHeightFromRailTop().floatValue()))
            .body("stopHeightFromSidewalk", equalTo(hslAccessibilityProperties.getStopHeightFromSidewalk().floatValue()))
    ...
    public void testInsertHslAccessibilityPropertiesForStop() {
              ...
              stopPlace: mutateStopPlace(StopPlace: {
                ...
                accessibilityAssessment: {
                  ...
                  hslAccessibilityProperties: {
                    ...
                    stopHeightFromRailTop: 33.55
                    stopHeightFromSidewalk: 4.5
        ...
        executeGraphqQLQueryOnly(graphqlQuery)
            ...
            .body("stopHeightFromRailTop", equalTo(33.55f))
            .body("stopHeightFromSidewalk", equalTo(4.5f))
    ...
    public void testMutateHslAccessibilityPropertiesOfStopClearFields() {
              ...
              stopPlace: mutateStopPlace(StopPlace: {
                ...
                accessibilityAssessment: {
                  ...
                  hslAccessibilityProperties: {
                    ...
                    stopHeightFromRailTop: null
                    stopHeightFromSidewalk: null
        ...
        executeGraphqQLQueryOnly(graphqlQuery)
            ...
            .body("stopHeightFromRailTop", equalTo(null))
            .body("stopHeightFromSidewalk", equalTo(null))
    ...
    private HslAccessibilityProperties createHslAccessibilityProperties() {
        ...
        hslAccessibilityProperties.setStopHeightFromRailTop(10.);
        hslAccessibilityProperties.setStopHeightFromSidewalk(7.);
